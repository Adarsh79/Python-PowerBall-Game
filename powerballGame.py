...
print("Hello! Welcome to The Powerball Lottery")
print()
...
if age < 18:
	print("You are underage... Please take precautions")
else:
	print("Being an adult you are good to go!")
...
tickets_per_drawing = int(input("How many tickets do you want? (2$ each) :"))
# maximum number of drawings per year is 156
num_drawing = int(input("Number of drawings you want? (Reminder - Maximum drawings per year is 156): "))
...
if times_won["5+P"] == 0:
	print("You didn't hit the jackpot!")
else:
	print('You hit the jackpot! Congratulations')
